...
.menu {
  background: #fff;
  border-radius: .1rem;
  box-shadow: 0 .05rem .2rem rgba(128, 0, 51, .3);
  list-style: none;
  margin: 0;
  min-width: 180px;
  padding: .4rem;
...
.modal-container {
  background: #fff;
  border-radius: .1rem;
  box-shadow: 0 .2rem .5rem rgba(128, 0, 51, .3);
  display: flex;
  display: -ms-flexbox;
  -ms-flex-direction: column;
  flex-direction: column;
...
.toast {
  background: rgba(128, 0, 51, .95);
  border: .05rem solid #800033;
  border-color: #800033;
  border-radius: .1rem;
  color: #fff;
  display: block;
...
.divider-vert::before {
  border-left: .05rem solid #ffcde1;
  bottom: .4rem;
  content: "";
  display: block;
  left: 50%;
